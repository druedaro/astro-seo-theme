...
- **Interactividad UI:** **React** (utilizado solo cuando sea necesario mediante _Astro Islands_ para no penalizar la carga).
...
1. **`astro-seo-meta`**: Paquete robusto para meta tags estándar (title, descripción, OG, twitter cards). _(Alternativa: `astro-seo` de Jonas)._
...
- Validaciones de _Core Web Vitals_ en CI (Continuous Integration) para mantener la puntuación Lighthouse de 100/100 en Performance, SEO y Accesibilidad.
